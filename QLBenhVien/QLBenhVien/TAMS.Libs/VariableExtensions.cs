...
namespace TAMS.Libs
{
    ...
    public static class StatusVatTu
    {
        ...
        public static string GetText(int stt)
        {
            ...
            {
                case 1:
                    return "Vật tư tiêu hao dùng 1 lần";

                case 2:
                    return "Dụng cụ Y tế";

                case 3:
                    return "Hóa chất, sinh phẩm xét nghiệm";
        ...
        public static List<SelectListModel> GetDic()
        {
            return new List<SelectListModel>() {
                new SelectListModel
                {
                    Value=1,Text="Vật tư tiêu hao dùng 1 lần"
                },
                new SelectListModel
                {
                    Value=2,Text="Dụng cụ Y tế"
                },
                new SelectListModel
                {
                    Value=3,Text="Hóa chất, sinh phẩm xét nghiệm"
                }
            };
        }
    }
    ...
    public static class StatusVatTuYTe
    {
        public const int A = 1;
        public const int B = 2;
        public const int C = 3;
    ...
    public static class StatusDungCu
    {
        public const int A = 1;
        public const int B = 2;
        public const int C = 3;
        ...
        public static string GetText(int stt)
        {
            ...
            {
                case 1:
                    return "Dụng cụ thăm khám";

                case 2:
                    return "Dụng cụ phẫu thuật";

                case 3:
                    return "Dụng cụ phẫu thuật nội soi";
        ...
        public static List<SelectListModel> GetDic()
        {
            return new List<SelectListModel>() {
                new SelectListModel
                {
                    Value=1,Text="Dụng cụ thăm khám"
                },
                new SelectListModel
                {
                    Value=2,Text="Dụng cụ phẫu thuật"
                },
                new SelectListModel
                {
                    Value=3,Text="Dụng cụ phẫu thuật nội soi"
                }
            };
        }
    }
    public static class StatusHoaChat
    {
        public const int A = 1;
        public const int B = 2;
        public const int C = 3;
        ...
        public static string GetText(int stt)
        {
            ...
            {
                case 1:
                    return "Hóa chất xét nghiệm đặc dùng với thiết bị";

                case 2:
                    return "Hóa chất thông thường";
        ...
        public static List<SelectListModel> GetDic()
        {
            return new List<SelectListModel>() {
                new SelectListModel
                {
                    Value=1,Text="Hóa chất xét nghiệm đặc dùng với thiết bị"
                },
                new SelectListModel
                {
                    Value=2,Text="Hóa chất thông thường"
                },
                new SelectListModel
                {
                    Value=3,Text="Sinh phẩm xét nghiệm"
                }
            };
        }
    }
